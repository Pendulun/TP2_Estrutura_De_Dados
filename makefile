...
$(BUILD)main.o:	$(SRC)main.cpp $(INCLUDE)$(AGENDA)Lectures.hpp  
	$(CC) $(CFLAGS) -I $(INCLUDE)$(AGENDA) $(INCLUDE)$(ORD) -c $(SRC)main.cpp -o $(BUILD)main.o
...
$(BUILD)$(AGENDA)Lectures.o: $(SRC)$(AGENDA)Lectures.cpp $(INCLUDE)$(AGENDA)Lectures.hpp $(INCLUDE)$(AGENDA)Planet.hpp  $(INCLUDE)$(ORD)MergeSort.hpp $(INCLUDE)$(ORD)RadixSort.hpp
	$(CC) $(CFLAGS) -I $(INCLUDE)$(ORD) -c $(SRC)$(AGENDA)Lectures.cpp -o $(BUILD)$(AGENDA)Lectures.o
...
$(BUILD)$(ORD)MergeSort.o:	$(SRC)$(ORD)MergeSort.cpp $(INCLUDE)$(ORD)MergeSort.hpp
	$(CC) $(CFLAGS) -c $(SRC)$(ORD)MergeSort.cpp -o $(BUILD)$(ORD)MergeSort.o

$(BUILD)$(ORD)RadixSort.o:	$(SRC)$(ORD)RadixSort.cpp $(INCLUDE)$(ORD)RadixSort.hpp
	$(CC) $(CFLAGS) -c $(SRC)$(ORD)RadixSort.cpp -o $(BUILD)$(ORD)RadixSort.o
